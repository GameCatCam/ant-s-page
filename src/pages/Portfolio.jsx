          ...
          <div className="projects">
            ...
            <div className="project-row">
              <figure>
                ...
                <a href="https://github.com/Anthony-GG/react-portfolio-webpage"><img style={{ width: '5%' }} className = "social-media-icons" src = "../src/assets/images/github-social.png" alt="an icon representing GitHub"/></a>
              </figure>
              ...
              <figure>
                ...
                <a href="https://github.com/Anthony-GG/mongo-social-media-api"><img style={{ width: '5%' }} className = "social-media-icons" src = "../src/assets/images/github-social.png" alt="an icon representing GitHub"/></a>
              </figure>
              ...
              <figure>
                ...
                <a href="https://github.com/Anthony-GG/event-forecaster"><img style={{ width: '5%' }} className = "social-media-icons" src = "../src/assets/images/github-social.png" alt="an icon representing GitHub"/></a>
              </figure>
            </div>
            ...
            <div className="project-row">
              <figure>
                ...
                <a href="https://github.com/Anthony-GG/note-registry"><img style={{ width: '5%' }} className = "social-media-icons" src = "../src/assets/images/github-social.png" alt="an icon representing GitHub"/></a>
              </figure>
              ...
              <figure>
                ...
                <a href="https://github.com/Anthony-GG/programming-quiz"><img style={{ width: '5%' }} className = "social-media-icons" src = "../src/assets/images/github-social.png" alt="an icon representing GitHub"/></a>
              </figure>
              ...
              <figure>
                ...
                <a href="https://github.com/Anthony-GG/dice-detection-application"><img style={{ width: '5%' }} className = "social-media-icons" src = "../src/assets/images/github-social.png" alt="an icon representing GitHub"/></a>
              </figure>
            </div>
          </div>
        </section>
